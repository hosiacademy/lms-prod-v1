  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        TabBar(
          controller: _tabs,
          tabs: const [Tab(text: 'Bulk Outreach'), Tab(text: 'Direct Outreach')],
        ...
        Expanded(
          child: TabBarView(
            controller: _tabs,
            children: [
              _buildBulkFlow(theme, colors),
              _buildDirectFlow(theme, colors),
            ],
          ),
        ),
      ],
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(30),
          boxShadow: isActive ? [BoxShadow(color: colors.primary.withOpacity(0.3), blurRadius: 8, offset: const Offset(0, 2))] : null,
        ),
        child: Row(
          children: [
          ...
          children: [
            ...
            if (_targetMode == 'numbers')
              ...
              DropdownButtonFormField<int>(
                initialValue: _selectedMailingListId,
