"""
State-only migration: adds all DB columns that exist in the 'enrollments' table
but were missing from the Enrollment Django model.
No ALTER TABLE is executed — all columns already exist in the DB.
"""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('payments', '0026_enrollment_fee_field'),
        ...
        migrations.SeparateDatabaseAndState(
            ...
            state_operations=[
                migrations.AddField(
                    ...
                    field=models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='Discount Applied'),
                ),
                migrations.AddField(
                    model_name='enrollment',
                ...
                migrations.AddField(
                    model_name='enrollment',
                    name='verified_by',
                    field=models.ForeignKey(blank=True, db_column='verified_by_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='verified_enrollments', to=settings.AUTH_USER_MODEL, verbose_name='Verified By'),
                ),
                migrations.AddField(
                    model_name='enrollment',
                    name='verified_at',
